    ...
    return (
        <Container className="pt-2">
            ...
            >
                ...
                voluptatibus ea officia illo doloribus. Sunt possimus quidem
                doloribus quia voluptatibus sit, veniam ex dicta nulla
                temporibus, praesentium, voluptates ea ad!
            </GeneratedDescription>
